...
import 'doctor cubit/doctor_states.dart';

class Doctor_ProfileScreen extends StatelessWidget {
  const Doctor_ProfileScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context)=> Doctor_Cubit()..get_profile_data(),
      child: BlocConsumer<Doctor_Cubit , Doctor_States>(
          builder: (context , Doctor_States state){
            var cubit = Doctor_Cubit.get(context);
            return Scaffold(
              body: ConditionalBuilder(
                condition: state is! Doctor_Get_profile_Loading,
                builder: (context){
                  return SafeArea(
                    child: Padding(
                          ...
                          children: [
                            ...
                            Center(
                              child: Container(
                                ...
                                child: Icon(Icons.book_outlined ,size: 130,color: Colors.white,),
                              ),
                            ),
                            SizedBox(height: 10,),
                            Text(
                              '${cubit.profile_data!['instructorName']}',
                              style: TextStyle(
                                  color: Colors.white ,
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: 5,),
                                        Text(
                                          '${cubit.profile_data!['instructorPosition']}',
                                          style: TextStyle(
                                              color: Colors.white,
                                              fontSize: 15,
                                              fontWeight: FontWeight.bold
                                        ...
                                        Expanded(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Text(
                                                '${cubit.profile_data!['numberOfCoursesTaught']}' ,
                                        ...
                                        Expanded(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              SizedBox(width: 5,),
                                              Text(
                                                '${cubit.profile_data!['numberOfSuspendedStudents']}',
                                                style:TextStyle( color: Colors.white , fontSize: 18) ,
                                              )
                                            ],
                                          ),
